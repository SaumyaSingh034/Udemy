...
public class TableGrid {
	...
	public static void main(String[] args) {
		...
		{
			String runs = tableDriver.findElements(By.cssSelector("[class='cb-col cb-col-100 cb-scrd-itms'] div:nth-child(3)")).get(i).getText();
			int validRuns = Integer.parseInt(runs);
			sum = sum+validRuns;
		}
	...
	String abc = driver.findElement(By.xpath("//div[text()='Total']/following-sibling::div")).getText();
	int run = Integer.parseInt(abc);
